      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {achievements.map(({ title, detail, icon: Icon }, index) => (
          <motion.div
            ...
            className="rounded-lg border border-white/10 bg-white/[0.045] p-5 backdrop-blur-xl transition hover:-translate-y-1 hover:border-cyan-200/22 hover:bg-white/[0.065]"
          >
