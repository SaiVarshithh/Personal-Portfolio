  ...
  return (
    <section id="about" className="section-shell">
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        >
          <Card className="edge-glow relative overflow-hidden p-4 sm:p-6">
            ...
            <div className="relative grid min-h-[300px] place-items-center rounded-lg border border-white/10 bg-slate-950/62 p-4 sm:min-h-[420px] sm:p-6">
              <div className="relative grid h-40 w-40 place-items-center rounded-full border border-cyan-200/24 bg-cyan-300/[0.045] shadow-[0_0_80px_rgba(102,228,255,0.13)] sm:h-56 sm:w-56">
                ...
                <div className="text-center">
                  <div className="text-3xl font-semibold text-white sm:text-5xl">SV</div>
                  <div className="mt-2 text-xs font-medium text-cyan-100 sm:mt-3 sm:text-sm">
                    Backend Systems
                  </div>
                </div>
              </div>
              <div className="mt-4 grid gap-2 text-xs text-slate-300 sm:mt-8 sm:gap-3 sm:text-sm">
